...
VIDEO_EXTENSIONS = {".mp4", ".avi", ".mov", ".mkv", ".flv", ".wmv", ".webm", ".mpeg", ".mpg", ".3gp", ".ogv"}
...
def extract_frames(target_path: str, fps: float = 30) -> bool:
    ...
    #print(roop.globals.temp_frame_quality)
    temp_frame_quality = roop.globals.temp_frame_quality * 31 // 100
    #print(temp_frame_quality)
...
def create_video(target_path: str, fps: float = 30) -> bool:
    ...
    success = run_ffmpeg(commands)

    if success and os.path.exists(temp_output_path):
        print(f"✅ Video generado correctamente: {temp_output_path}")
    else:
        print(f"❌ ERROR: ffmpeg no pudo  el video en {temp_output_path}")
        success = False
...
def is_video(video_path: str) -> bool:
    if not video_path:
        print("Ruta de archivo vacía o None")
        return False
